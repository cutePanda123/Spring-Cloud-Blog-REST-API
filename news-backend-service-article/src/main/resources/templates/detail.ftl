        ...
        <div class="white-header">
            <div class="white-bar">
                ...
                <div class="right-part">
					...
					<a href="javascript:(0);" @click="goAdminCenter()" class="white-header-right" style="margin-right: 20px;">管理平台</a>
				</div>
            </div>
        </div>
        ...
        var articleList = new Vue({
            ...
            methods: {
                ...
                queryByCategory(catId) {
                    var me = this;
                    window.location = "index.html?catId=" + catId;
                },
                // 文章阅读数累加
                readArticle(articleId) {
                    ...
                    axios.post(articleServerUrl + "/article/portal/readcount?articleId=" + articleId)
                    .then(res => {
                ...
                getArticleDetail(articleId) {
                    ...
                    var articleServerUrl = app.articleServerUrl;
                    axios.defaults.withCredentials = true;
                    axios.get(articleServerUrl + "/article/portal/get?articleId=" + articleId)
                    .then(res => {
                        // console.log(JSON.stringify(res.data));
                ...
                getCommentCounts() {
                    ...
                    var articleServerUrl = app.articleServerUrl;
                    axios.defaults.withCredentials = true;
                    axios.get(articleServerUrl + "/comment/count?articleId=" + me.articleId)
                    .then(res => {
                        console.log(JSON.stringify(res.data));
                ...
                commentDisplay(fatherCommentId, articleContent) {
                    ...
                    var articleServerUrl = app.articleServerUrl;
                    axios.defaults.withCredentials = true;
                    axios.post(articleServerUrl + '/comment/create',
                        commentReplyBO,
                        {
                            headers: {
                                'headerUserId': uid,
                ...
                getAllCategory() {
                    ...
                    axios.defaults.withCredentials = true;
                    axios.get(adminServerUrl + "/categoryMng/listCategory")
                    .then(res => {
                        console.log(JSON.stringify(res.data));
